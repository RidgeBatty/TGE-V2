...
const main = async () => {        
    ...
    try {        
        Engine.addActor('actor', { imgUrl:'img/level1.jpg', scale:1.15, position:Engine.dims.clone().mulScalar(0.5) });                
        ...
        console.log('Failed initialize/load assets for Controllers demo!');
        console.log(e);
        return;
    }
